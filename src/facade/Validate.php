...
namespace meilunzhi\validate\facade;

use think\facade\Db;

/**
 * @see \meilunzhi\validate\Validate
 * @package think\facade
 * @mixin \meilunzhi\validate\Validate
 * @method static void setDb(Db $db) 设置Db对象
 * @method static void setRequest(\support\Request $request) 设置Request对象
 * @method static \meilunzhi\validate\Validate rule(string|array $name, mixed $rule = '') 添加字段验证规则
 * @method static \meilunzhi\validate\Validate extend(string $type, callable $callback = null, string $message = null) 注册验证（类型）规则
 ...
 * @method static \meilunzhi\validate\Validate scene(string $name) 设置验证场景
 * @method static bool hasScene(string $name) 判断是否存在某个验证场景
 * @method static \meilunzhi\validate\Validate batch(bool $batch = true) 设置批量验证
 * @method static \meilunzhi\validate\Validate failException(bool $fail = true) 设置验证失败后是否抛出异常
 * @method static \meilunzhi\validate\Validate only(array $fields) 指定需要验证的字段列表
 * @method static \meilunzhi\validate\Validate remove(string|array $field, mixed $rule = null) 移除某个字段的验证规则
 * @method static \meilunzhi\validate\Validate append(string|array $field, mixed $rule = null) 追加某个字段的验证规则
...
class Validate
{
    ...
    {
        if (!static::$_instance) {
            static::$_instance = new \meilunzhi\validate\Validate();
        }
